...
app.Animation = (function () {
	...
	function initialize() {
		...
		// t.set(end, {opacity:1, visibility:"visible"});
	...
	function start() {
		...
		tl2.to(catContainer, .5, {y:"-=300", ease:Circ.easeOut}, "+=2.7")
		.to(catContainer, 1, {y:"+=600", ease:Circ.easeIn},"+=.1")

		.to(mask1, 1.5, {x:"-=160", ease:Circ.easeIn}, "-=1.2")
		.to(mask2, 1.5, {x:"+=160", ease:Circ.easeIn}, "-=1.5");
