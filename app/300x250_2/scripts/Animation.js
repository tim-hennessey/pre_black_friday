...
app.Animation = (function () {
	...
	function initialize() {
		...
		// t.set(".end-frame", {visibility:"visible"});
	...
	function start() {
		...
		tl2.to(catContainer, .5, {y:"-=50", ease:Circ.easeOut}, "+=2.7")
		.to(catContainer, 1, {y:"+=300", ease:Circ.easeIn},"+=.1")

		.to(mask1, 1.35, {x:"-=300", ease:Circ.easeIn}, "-=1.2")
		.to(mask2, 1.35, {x:"+=300", ease:Circ.easeIn}, "-=1.35");
