...
app.Animation = (function () {
	...
	function start() {
		...
		tl2.to(catContainer, .5, {y:"-=20", ease:Circ.easeOut}, "+=2.7")
		.to(catContainer, .5, {y:"+=200", ease:Circ.easeIn},"+=.1")

		.to(mask1, .7, {x:"-=728", ease:Circ.easeIn}, "-=.5")
		.to(mask2, .7, {x:"+=728", ease:Circ.easeIn}, "-=.7");
